-- The schema an installation had before the slug migration, taken verbatim
-- from schema.sql at 3b52215 (the last commit before
-- migrations/1715019045_add_slug_columns.sql). Used to prove that migration
-- still upgrades a real pre-slug database rather than a reconstruction of
-- one.
create table meta(
